...
def storeInFile(df):
    destDir = '/Users/vk/MachineLearning/Stocks/data/EOD_RETURN/'    
...
if __name__ == '__main__':
    ...
    async_result = p.map_async(yfin.MultipleDaysReturn, symbols)
    p.close()
    p.join() 
    ...
    df = pd.DataFrame(res, columns=['Stock', 'TradeDate', '1DayReturnPercent', '2DayReturnPercent', '3DayReturnPercent', '5DayReturnPercent', '10DayReturnPercent', '15DayReturnPercent', '30DayReturnPercent'])
    storeInFile(df)
